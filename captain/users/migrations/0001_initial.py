...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'users_userprofile', (
            ...
            ('display_name', self.gf('django.db.models.fields.CharField')(default='Anonymous', max_length=256)),
        ))
    ...
    models = {
        ...
        u'users.userprofile': {
            ...
            'display_name': ('django.db.models.fields.CharField', [], {'default': "'Anonymous'", 'max_length': '256'}),
