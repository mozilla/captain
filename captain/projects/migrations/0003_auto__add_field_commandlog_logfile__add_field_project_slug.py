...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CommandLog.logfile'
        db.add_column(u'projects_commandlog', 'logfile',
    ...
    def backwards(self, orm):
        # Deleting field 'CommandLog.logfile'
        db.delete_column(u'projects_commandlog', 'logfile')
