...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SentCommand'
        db.create_table(u'projects_sentcommand', (
        ...
        db.send_create_signal(u'projects', ['SentCommand'])

        # Adding field 'CommandLog.sent_command'
        db.add_column(u'projects_commandlog', 'sent_command',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['projects.SentCommand'], null=True),
                      keep_default=False)

        # Adding field 'CommandLog.shove_instance'
        db.add_column(u'projects_commandlog', 'shove_instance',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['projects.ShoveInstance'], null=True),
                      keep_default=False)

        # Adding field 'ScheduledCommand.hostnames'
        db.add_column(u'projects_scheduledcommand', 'hostnames',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'SentCommand'
        db.delete_table(u'projects_sentcommand')

        # Deleting field 'CommandLog.sent_command'
        db.delete_column(u'projects_commandlog', 'sent_command_id')

        # Deleting field 'CommandLog.shove_instance'
        db.delete_column(u'projects_commandlog', 'shove_instance_id')

        # Deleting field 'ScheduledCommand.hostnames'
        db.delete_column(u'projects_scheduledcommand', 'hostnames')
