...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field shove_instances on 'Project'
        m2m_table_name = db.shorten_name(u'projects_project_shove_instances')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('project', models.ForeignKey(orm[u'projects.project'], null=False)),
            ('shoveinstance', models.ForeignKey(orm[u'projects.shoveinstance'], null=False))
        ))
        db.create_unique(m2m_table_name, ['project_id', 'shoveinstance_id'])


    def backwards(self, orm):
        # Removing M2M table for field shove_instances on 'Project'
        db.delete_table(db.shorten_name(u'projects_project_shove_instances'))
    ...
    models = {
        ...
        u'projects.project': {
            ...
            'shove_instances': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'projects'", 'symmetrical': 'False', 'to': u"orm['projects.ShoveInstance']"}),
