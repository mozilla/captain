...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'projects_commandlog', (
        ...
        db.send_create_signal(u'projects', ['CommandLog'])

        # Adding field 'Project.queue'
        db.add_column(u'projects_project', 'queue',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=256),
                      keep_default=False)

        # Adding field 'Project.project_name'
        db.add_column(u'projects_project', 'project_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=256),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'projects_commandlog')

        # Deleting field 'Project.queue'
        db.delete_column(u'projects_project', 'queue')

        # Deleting field 'Project.project_name'
        db.delete_column(u'projects_project', 'project_name')
    ...
    models = {
        ...
        u'projects.project': {
            ...
            'queue': ('django.db.models.fields.CharField', [], {'max_length': '256'})
        }
    }
