...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'projects_scheduledcommand', (
            ...
            ('interval_minutes', self.gf('django.db.models.fields.IntegerField')(default=15)),
            ('last_run', self.gf('django.db.models.fields.DateTimeField')(null=True)),
        ))
        db.send_create_signal(u'projects', ['ScheduledCommand'])


        # Changing field 'CommandLog.user'
        db.alter_column(u'projects_commandlog', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))

    def backwards(self, orm):
        # Deleting model 'ScheduledCommand'
        db.delete_table(u'projects_scheduledcommand')


        # User chose to not deal with backwards NULL issues for 'CommandLog.user'
        raise RuntimeError("Cannot reverse this migration. 'CommandLog.user' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'CommandLog.user'
        db.alter_column(u'projects_commandlog', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
