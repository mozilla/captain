...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CommandLog.return_code'
        db.add_column(u'projects_commandlog', 'return_code',
                      self.gf('django.db.models.fields.IntegerField')(default=None, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CommandLog.return_code'
        db.delete_column(u'projects_commandlog', 'return_code')
